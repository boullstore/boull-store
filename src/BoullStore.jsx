...
export default function BoullStore() { const handleOrder = () => { const message = encodeURIComponent("Halo admin Boull Store, saya ingin melakukan top up."); window.open(https://wa.me/628881965214?text=${message}, '_blank'); };

return ( <div className="min-h-screen bg-gray-900 text-white font-sans"> {/* Navbar */} <header className="bg-gray-800 shadow-md"> <div className="container mx-auto flex justify-between items-center p-4"> <h1 className="text-2xl font-bold">Boull Store</h1> <nav> <ul className="flex gap-4"> <li><a href="#" className="hover:text-green-400">Home</a></li> <li><a href="#layanan" className="hover:text-green-400">Layanan</a></li> <li><a href="#pembayaran" className="hover:text-green-400">Pembayaran</a></li> <li><a href="#kontak" className="hover:text-green-400">Kontak</a></li> </ul> </nav> </div> </header>
...
{/* Hero Section */}
  <section className="text-center py-16 px-6 bg-gradient-to-br from-green-500 to-teal-500">
    ...
    <button onClick={handleOrder} className="bg-white text-green-600 font-semibold py-2 px-4 rounded hover:bg-gray-100">
      Mulai Top Up
    </button>
  </section>
  ...
  <section id="pembayaran" className="bg-gray-800 py-12 px-4">
    <div className="container mx-auto text-center">
      <h3 className="text-2xl font-bold mb-4">Metode Pembayaran</h3>
      <p className="mb-2">Dana, OVO, Gopay: 0881010542123 / 081219250468</p>
      <p className="mb-4">Atau scan QRIS berikut untuk membayar:</p>
      <div className="flex justify-center">
        <img src="/qris.jpg" alt="QRIS Pembayaran" className="w-64 rounded shadow-lg" />
      </div>
    </div>
  </section>
